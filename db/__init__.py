...
class MongoDatabase:
	...
	async def connect(self) -> None:
		await init_beanie(self._client, document_models=[User,Guild,AutoResponse,AutoResponseFileMask,Log,INFVersion,INFTextCorrection,INFCommandUsage,INFQOTD,INFExcuses,INFInsults,INFEightBall,INFBees,INFSauceNao])
